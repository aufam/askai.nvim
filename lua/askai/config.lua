...
---@alias AskAIConfigOllama {url: string, model: string}
...
---@field ollama AskAIConfigOllama?
...
function M.setup(opts)
	...
	M.options.ollama = vim.tbl_deep_extend("force", default_ollama, M.options.ollama or {})
end
